...
export type GetAllReviewsQuery = { __typename?: 'Query', productReviews: { __typename?: 'ProductReviewList', items: Array<{ __typename?: 'ProductReview', id: string, createdAt: any, authorName: string, summary: string, rating: number }> } };
