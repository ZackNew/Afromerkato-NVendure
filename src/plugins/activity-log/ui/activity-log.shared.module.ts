...
@NgModule({
  ...
  declarations: [ ProductRelatedActivityLogListComponent, AdminListComponent,
    ...
    ActivityLogListComponent, ProductChangesCompareComponent, ShippingMethodActivityLogListComponent,
    CollectionActivityLogListComponent, PaymentMethodActivityLogListComponent, ],
  exports: [SharedModule, ActivityLogListComponent,ProductChangesCompareComponent,  ShippingMethodActivityLogListComponent,
     PaymentMethodActivityLogListComponent, AdminListComponent,
    CollectionActivityLogListComponent, ActivityLogFilterComponent],
  providers: [
  ]
})
