import { VendureEntity, VendureEvent, EventBus, ID, ProcessContext, ProductEvent, RequestContext } from '@vendure/core';
import {
    Injectable,
    OnApplicationBootstrap,
  } from '@nestjs/common';
import { ActivityLogFilter } from '../gql/generated';
import {SelectQueryBuilder} from 'typeorm';
@Injectable()
export abstract class ActivityLogService<T extends VendureEvent>  implements OnApplicationBootstrap{
    abstract onApplicationBootstrap():void;
    abstract registerLog(event: T):void;
