...
@Injectable()
export class CustomerRelatedActivityLogService
  extends ActivityLogService<
    CustomerEvent | CustomerGroupEvent | CustomerGroupChangeEvent
  >
  implements OnApplicationBootstrap
{
  ...
  @Transaction()
  async registerLog(
    event: CustomerEvent | CustomerGroupEvent | CustomerGroupChangeEvent,
  ) {
  ...
  async activityLogs(
    ...
    let allLogsSelectQueryBuilder = this.transactionalConnection
      .getRepository(ctx, CustomerRelatedActivityLogEntity)
