import { Administrator, Channel, ChannelAware, SoftDeletable, Translatable, Translation } from '@vendure/core';
...
export abstract class ActivityLogEntity<T extends VendureEntity> extends VendureEntity implements ChannelAware, SoftDeletable, Translatable{
