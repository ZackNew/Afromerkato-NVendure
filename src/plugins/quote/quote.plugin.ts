...
import { deleteQuotePermissionDefinition, readQuotesPermissionDefinition, updateQuotesPermissionDefinition } from './permissions';
import { QuoteAccessAuthorizationMiddleware } from './quote-access-authorisation.middleware';
import { QuoteService } from './services/quote.service';
@VendurePlugin({
    imports: [PluginCommonModule],
    providers: [{ provide: QUOTE_PLUGIN_OPTIONS, useFactory: () => QuotePlugin.options },QuoteService],
